<?php
$SECCION="estadia"; $docDir="documentos/"; $entDir="entregados/"; require_once __DIR__.'/includes/upload_rules.php';
...
<?php $active='estadia'; include __DIR__.'/includes/nav.php'; ?>

<main class="page"><h1>ðŸ“ EstadÃ­a</h1>
