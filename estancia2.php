<?php
$SECCION="estancia2"; $docDir="documentos/"; $entDir="entregados/"; require_once 'upload_rules.php';
...
<?php $active='estancia2'; include 'nav.php'; ?>

<main class="page"><h1>📁 Estancia 2</h1>
