<?php
$SECCION="estancia2"; $docDir="documentos/"; $entDir="entregados/"; require_once __DIR__.'/includes/upload_rules.php';
...
<?php $active='estancia2'; include __DIR__.'/includes/nav.php'; ?>

<main class="page"><h1>ðŸ“ Estancia 2</h1>
